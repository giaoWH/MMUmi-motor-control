...
/**
************************************************************************
* @brief:      	dm4310_motor_init: DM4310/DM3507电机初始化函数
* @param:      	void
* @retval:     	void
* @details:    	初始化电机，设置默认参数和控制模式。
************************************************************************
**/
...
void fdcan1_rx_callback(void)
{
    ...
    {
        case 0x00: 
            // 简单区分：根据协议，判断是否为参数回复帧
            if (rx_data[2] == 0x33 || rx_data[2] == 0x55) {
...
// 【修改点】增加 FDCAN2 接收回调函数，处理 Motor2 的反馈数据
/**
************************************************************************
